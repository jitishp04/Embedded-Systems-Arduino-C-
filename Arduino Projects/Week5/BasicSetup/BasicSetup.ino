...
int redLED = 8;// red led is connected to the 13th digital pin
int buttonState = 0; //button is at 0, meaning its at normal pos
int pushButton = 7;//red led is connected to the 2nd digital pin
int greenLED = 12;// green led is connected to the 7th digital pin
...
void loop()
{
  ...
  buttonState = digitalRead(pushBuxtton);
